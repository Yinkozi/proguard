...
class ConfigurationConstants
{
    ...
    public static final String DONT_KEEP_OPTION                      = "-dontkeep";
    public static final String DONT_KEEP_CLASS_MEMBERS_OPTION        = "-dontkeepclassmembers";
    public static final String DONT_KEEP_CLASSES_WITH_MEMBERS_OPTION = "-dontkeepclasseswithmembers";
    public static final String DONT_KEEP_NAMES_OPTION                = "-dontkeepnames";
    public static final String DONT_KEEP_CLASS_MEMBER_NAMES_OPTION   = "-dontkeepclassmembernames";
    public static final String DONT_KEEP_CLASSES_WITH_MEMBER_NAMES_OPTION = "-dontkeepclasseswithmembernames";
    ...
    public static final String NAME_SEED_OPTION                      = "-nameseed";
    public static final String UTF8_NAMES_OPTION                     = "-utf8names";
    ...
    public static final String PRINT_MAPPING_JSON_OPTION              = "-printmappingjson";
