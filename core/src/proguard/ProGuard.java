...
public class ProGuard
{
    ...
    private void obfuscate() throws IOException
    {
        if (configuration.verbose)
        {
            ...
            // We'll print out the mapping in Json format, if requested.
            if (configuration.printMappingJson != null)
            {
                System.out.println("Printing mapping in Json format to [" + PrintWriterUtil.fileName(configuration.printMappingJson) + "]...");
            }
        }
