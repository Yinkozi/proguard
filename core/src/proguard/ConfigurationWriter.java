...
public class ConfigurationWriter
{
    ...
    public void write(Configuration configuration) throws IOException
    {
        ...
        writeOption(ConfigurationConstants.PRINT_MAPPING_JSON_OPTION,                        configuration.printMappingJson);
        ...
        writeOption(ConfigurationConstants.NAME_SEED_OPTION,   configuration.nameSeed);
        writeOption(ConfigurationConstants.UTF8_NAMES_OPTION,  configuration.utf8Names);
        writer.println();
    ...
    private void writeOption(String optionName, long argument)
    {
        writer.print(optionName);
        writer.print(' ');
        writer.println(argument);
