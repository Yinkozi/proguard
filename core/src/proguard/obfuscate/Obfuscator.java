...
public class Obfuscator
{
                        ...
                        ClassPool libraryClassPool) throws IOException
    {
        ...
        if (configuration.keep         == null &&
            ...
            configuration.printMappingJson == null)
        {
        ...
        programClassPool.classesAccept(
            new ClassObfuscator(programClassPool,
                                ...
                                configuration.nameSeed,
                                configuration.utf8Names));

        // Come up with new names for all class members.
        NameFactory nameFactory = new RandomNameFactory(configuration.nameSeed,
                configuration.utf8Names);
        ...
        NameFactory specialNameFactory =
            new SpecialNameFactory(new RandomNameFactory(configuration.nameSeed,
                    configuration.utf8Names));
        ...
        // Print out the mapping, if requested.
        if (configuration.printMappingJson != null)
        {
            PrintStream ps =
                configuration.printMappingJson == Configuration.STD_OUT ? System.out :
                    new PrintStream(
                    new BufferedOutputStream(
                    new FileOutputStream(configuration.printMappingJson)));

            // Print out items that will be removed.
            ps.println("{");
            programClassPool.classesAccept(new MappingJsonPrinter(ps));
