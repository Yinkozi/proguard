             ...
             ConstantVisitor
{
    ...
    private final long                  nameSeed;
    private final boolean               utf8Names;
    ...
    private String generateUniquePackagePrefix(String newSuperPackagePrefix)
    {
        ...
        if (packageNameFactory == null)
        {
            ...
            packageNameFactory = new RandomNameFactory(this.nameSeed, this.utf8Names);
    ...
    private String generateUniqueClassName(String newPackagePrefix)
    {
        ...
        if (classNameFactory == null)
        {
            ...
            classNameFactory = new RandomNameFactory(this.nameSeed, this.utf8Names);
